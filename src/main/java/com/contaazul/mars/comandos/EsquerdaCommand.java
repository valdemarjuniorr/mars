...
public class EsquerdaCommand extends AbstractCommand {

	public EsquerdaCommand(Robo robo) {
		super(Direcao.ESQUERDA);
		this.robo = robo;
	}
	...
	public void execute() {
		...
		switch (orientacao) {
			...
			case EAST:
				...
				break;
			default:
				throw new IllegalStateException("Não é possível virar a esquerda");
		}
	}
